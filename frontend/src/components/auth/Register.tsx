...
import { User, Mail, Lock, AlertCircle, ArrowRight, Fingerprint, ChevronLeft } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg-primary p-6 relative overflow-hidden font-['Inter']">
      ...
      >
        <Link 
          to="/home" 
          className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-text-muted hover:text-emerald-500 transition-colors mb-8 group"
        >
        ...
        <div className="mt-10 pt-8 border-t border-white/5 flex flex-col items-center gap-4">
          ...
          <Link to="/home/login" className="text-sm font-bold text-emerald-500 hover:text-emerald-400 transition-colors">
            Log In
          </Link>
        </div>
      </motion.div>
